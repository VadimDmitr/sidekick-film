    ...
    <div className={styles.servicesContainer} id="services">
      ...
      <div className={styles.serviceCard}>
        <p className={styles.serviceDescription}>
          Whether you're looking to promote your brand, cover a special event,
          or produce educational content, our state-of-the-art equipment and
          skilled professionals are at your service. We understand the power of
          visual storytelling and strive to create content that not only looks
      ...
      <div className={styles.serviceCard}>
        <p className={styles.serviceDescription}>
          ...
          take on is not just seen, but felt. With SideKick Film Co., your
          vision is our mission. Let us help you tell your story and leave a
